...
const useStyles = makeStyles((theme) => ({
  ...
  image: {
    backgroundImage: 'url(https://www.pikpng.com/pngl/b/251-2513594_events-png-clipart.png)',
      ...
      <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
        <div className={classes.paper}>
          ...
          <Grid container>
            <Grid item xs>
              <Link to="/signup">
                <Typography variant="body2" style={{color: "#737373"}} align="left">
                 Sign Up as Guest
                    </Typography>
              </Link>
            </Grid>
            <Grid item>
              <Link to="/login" >
                <Typography variant="body2" style={{color: "#737373"}} align="right">
                  Contact Admin
                </Typography>
              </Link>
            </Grid>
